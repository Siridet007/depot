...
<head>
    ...
    <title>เพิ่มข้อมูลเอกสาร น.ม.10/1</title>
    <style>
        body {
        ...
        <div class="collapse navbar-collapse" id="main_nav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active" style="margin-left:20px">
                    <?php if (($name == 'susco')) { ?>
                        <a class="nav-link"
                            href="../document/doc101.php?name=susco&id=<?php echo $id ?>&user=<?php echo $user ?>">
                            กลับหน้าเอกสาร
                        </a>
                    <?php } else if (($name == 'bck')) { ?>
                            <a class="nav-link"
                                href="../document/doc101.php?name=bck&id=<?php echo $id ?>&user=<?php echo $user ?>">
                                กลับหน้าเอกสาร
                            </a>
                    <?php } else if (($name == 'pkn')) { ?>
                                <a class="nav-link"
                                    href="../document/doc101.php?name=pkn&id=<?php echo $id ?>&user=<?php echo $user ?>">
                                    กลับหน้าเอกสาร
                                </a>
                    <?php } else if (($name == 'ptg')) { ?>
                                    <a class="nav-link"
                                        href="../document/doc101.php?name=ptg&id=<?php echo $id ?>&user=<?php echo $user ?>">
                                        กลับหน้าเอกสาร
                                    </a>
                    <?php } else if (($name == 'mk')) { ?>
                                        <a class="nav-link"
                                            href="../document/doc101.php?name=mk&id=<?php echo $id ?>&user=<?php echo $user ?>">
                                            กลับหน้าเอกสาร
                                        </a>
                    <?php } ?>
                </li>
                    ...
                    <tr>
                        ...
                        <td width="60%">
                            ...
                            <h2 class="text ml-5"><b>
                                    &nbsp;&nbsp;&nbsp;
                                    แบบรายงานการจ่ายน้ำมันจากต่างประเทศ<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    (สถานีปลายทาง)</b>
                            </h2>
                        ...
                        <td>
                            <h3 align="center"><b>น.ม.10/1</b></h3>
                        </td>
                    </tr>
                </thead>
            </table>
            <form action="../db/forms_dbten1.php" method="post">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label for="no_bill99">เลขที่เอกสาร (ตามแบบ กศก.99/1)</label>
                            <input type="text" class="form-control" name="no_bill99" style="font-size:20px">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="ship_import">ชื่อเรือที่นำเข้า</label>
                            <input type="text" class="form-control" name="ship_import" style="font-size:20px">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="country">ประเทศต้นทาง</label>
                            <input type="text" class="form-control" name="country" style="font-size:20px">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="type99" style="font-size:19px">ประเภทน้ำมันที่นำเข้า (ตามแบบ กศก.99/1)</label>
                            <input type="text" class="form-control" name="type99" style="font-size:20px">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="density" placeholder="Kg/m^3 @ 15 ํC"
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="gravity" placeholder="Kg/m^3 @ 15 ํC"
                                style="font-size:20px">
                        </div>
                    </div>
                    <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="density_tank" placeholder="Kg/m^3 @ 15 ํC"
                                style="font-size:20px">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="gravity_tank" placeholder=" ํAPI @ 68 ํF"
                                style="font-size:20px">
                        </div>
                    </div>
                    <div class="col">
