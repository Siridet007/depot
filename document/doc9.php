...
if (($_GET['name']) == 'susco') {
    ...
    $sql = $conn->prepare("SELECT * FROM NM09");
    $sql->execute();
    $result = $sql->fetchAll();
            ...
            <table border="0">
                <tr>
                    <td align="center" width="1000px">
                        <h1><b>เอกสาร น.ม.9</b></h1>
                    </td>
                    <td align="right">
                        <right>
                            <form action="../forms/form9.php" method="get">
                ...
                <?php } else { ?>
                    <?php foreach ($result as $z) { ?>
                        <tr>
                            ...
                            <?php if (($z['name_depot']) != '') { ?>
                                <td align="center">
                                    <form action="paper/paper9.php" method="post">
                                        <?php $aa = $z['ID'] ?>
                                        <input name="id" type="hidden" value="<?= $aa ?>">
                                        <input name="db" type="hidden" value="<?= $_GET['name'] ?>">
                                        <input name="user" type="hidden" value="<?= $_GET['user'] ?>">
                                        <input class="btn btn-primary" type="submit" value="ดูข้อมูล" name="goto"
                            ...
                            <?php } else { ?>
                                ...
                                <td align="center">
                                    <form action="paper/paperimg.php" method="post">
