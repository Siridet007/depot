                ...
                <table border="1" style="width:950px ;margin:10px ">
                    ...
                    <tbody>
                        ...
                        <tr align="center">                          
                            ...
                            <td><?php echo $z['TK14_Total_Max'] ?> </td>
                            <td><?php echo $z['TK14_Total_Min'] ?> </td>
                            <td><?php echo $z['TK14_Level_Max'] ?> </td>
                            <td><?php echo $z['TK14_Level_Min'] ?> </td>
                            <td><?php echo $z['TK14_Temp'] ?> </td>
                            <td><?php echo $z['TK15_Total_Max'] ?> </td>
                            <td><?php echo $z['TK15_Total_Min'] ?> </td>
                            <td><?php echo $z['TK15_Level_Max'] ?> </td>
                            <td><?php echo $z['TK15_Level_Min'] ?> </td>
