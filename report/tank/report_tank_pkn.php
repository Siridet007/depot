        ...
        <div class="card">
            ...
            <center>
                <table border="1" style="width:950px ;margin:10px ">
                    <thead>
                        <tr align="center">
                            <td rowspan="2"><font size="3"><b>เวลา</b></font></td>
                            <td colspan="4"><font size="4"><b>Tank12</b></td>
                            <td colspan="4"><font size="4"><b>Tank15</b></td>
                            <td colspan="4"><font size="4"><b>Tank16</b></td>
                            <td colspan="4"><font size="4"><b>Tank17</b></td>
                        </tr>
                        <tr align="center">
                            <td><font size="3"><b>ปริมาณน้ำมัน<br>(ลิตร)</b></td>
                            <td><font size="3"><b>ระดับน้ำมัน<br>(ลิตร)</b></td>
                            <td><font size="3"><b>อุณหภูมิ<br> ( ํC)</b></td>
                            <td><font size="3"><b>สถานะวาล์ว<br>(เปิด/ปิด)</b> </td>
                    ...
                    <tbody>
                        ...
                        <tr align="center">                           
                            <td><font size="3"><?php echo $z['Time'] ?> </td>

                            <td><font size="3"><?php echo $z['TK12_Total'] ?> </td>
                            <td><font size="3"><?php echo $z['TK12_Level'] ?> </td>
                            <td><font size="3"><?php echo $z['TK12_Temp'] ?> </td>
                            <td><font size="3"><?php echo $z['TK12_Valve_Sts'] ?> </td>

                            <td><font size="3"><?php echo $z['TK15_Total'] ?> </td>
                            <td><font size="3"><?php echo $z['TK15_Level'] ?> </td>
                            <td><font size="3"><?php echo $z['TK15_Temp'] ?> </td>
                            <td><font size="3"><?php echo $z['TK15_Valve_Sts'] ?> </td>

                            <td><font size="3"><?php echo $z['TK16_Total'] ?> </td>
                            <td><font size="3"><?php echo $z['TK16_Level'] ?> </td>
                            <td><font size="3"><?php echo $z['TK16_Temp'] ?> </td>
                            <td><font size="3"><?php echo $z['TK16_Valve_Sts'] ?> </td>

                            <td><font size="3"><?php echo $z['TK17_Total'] ?> </td>
                            <td><font size="3"><?php echo $z['TK17_Level'] ?> </td>
                            <td><font size="3"><?php echo $z['TK17_Temp'] ?> </td>
                            <td><font size="3"><?php echo $z['TK17_Valve_Sts'] ?> </td>
