...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <br>
            <center>
                <h2><b>รายงานการรับ-จ่ายน้ำมันชายฝั่ง (น้ำมันดีเซล)</b></h2>
            </center>
            <div class="row">
                <div class="col">
                    <center>
                        <div class="card" style="width:300px">
                            <div class="card-body">
                                <center>
                                    <h3 class="card-title">กรุณาเลือกวันที่ <br>วัน/เดือน/ปี</h3>
                                    <center>
                            </div>
                            <center>
                                <form action="oil/report.php" method="post">
                                    <div class="row">
                                        <div class="col">
                ...
                <div class="col">
                    <center>
                        <div class="card" style="width:300px">
                            <div class="card-body">
                                <center>
                                    <h3 class="card-title">กรุณาเลือกเดือน <br>เดือน/ปี</h3>
                                    <center>
                            </div>
                            <center>
                                <form action="oil/report1.php" method="post">
                                    <div class="row">
                                        <div class="col">
                                            <select name="month" required="required">
                                                <option value="" selected>เดือน</option>
