...
if (isset($_POST['save'])) {
    ...
    if (empty($name_depot)) {
        ...
        $_SESSION['db'] = $db;
        $_SESSION['user'] = $user;
        header("location: ../forms/form10.php");
        ...
        $_SESSION['error'] = 'กรุณากรอกสถานีต้นทาง';
        $_SESSION['id'] = $id;
        $_SESSION['db'] = $db;
        $_SESSION['user'] = $user;
        header("location: ../forms/form10.php");
        ...
        try {
            ...
            if (!isset($_SESSION['error'])) {
                $stmt = $conn->prepare("INSERT INTO NM10(name_depot, province1, tel, no_bill, name_ship, round, type_fuel, origin, province2, density, gravity, volume1, date_start, time_start, date_end, time_end, no_tank, pot, date_start_pump, time_start_pump, date_end_pump, time_end_pump, spend_time_pump, density_tank, gravity_tank, volume2,  brand, amount)
                                            VALUES(:name_depot, :province1, :tel, :no_bill, :name_ship, :round, :type_fuel, :origin, :province2, :density, :gravity, :volume1, :date_start, :time_start, :date_end, :time_end, :no_tank, :pot, :date_start_pump, :time_start_pump, :date_end_pump, :time_end_pump, :spend_time_pump, :density_tank, :gravity_tank, :volume2,  :brand, :amount)");
